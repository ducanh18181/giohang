...
<html lang="en">
    <head>
        ...
        <title> Quản lý sự kiện phụ</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản lý sự kiện phụ</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Admin</a>
                                        </li>
                                        <li>
                                            <a href="#">Sự kiện phụ </a>
                                        </li>
                                        <li class="active">
                                        Quản lý sự kiện phụ
                                        </li>
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Sự kiện phụ đã xóa</h4>
...
<td colspan="7" align="center"><h3 style="color:red"></h3></td>
<tr>
<?php 
} else {
