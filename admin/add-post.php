...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Thêm bài viết</title>
                                    ...
                                    <div class="">
                                        <form name="addpost" method="post" enctype="multipart/form-data">
                                            <div class="form-group m-b-20">
                                                ...
                                                <input type="text" class="form-control" id="posttitle" name="posttitle" placeholder="Tiêu đề" required>
                                            </div>
                                            ...
                                            <div class="form-group m-b-20">
                                                ...
                                                <select class="form-control" name="category" id="category" onChange="getSubCat(this.value);" required>
                                                    <option value="">Lựa chọn sự kiện </option>
                                                    <?php
